...
const dropdownlargeOptionsList1 = [
  { label: "1", value: "1" },
  { label: "2", value: "2" },
  { label: "3", value: "3" },
]

const dropdownlargeOptionsList2 = [
  { label: "1", value: "1" },
  { label: "2", value: "2" },
  { label: "3", value: "3" },
]
...
const ListingPage = () => {
  ...
  // State variable for the list of cards
  ...
  const addNewCard = () => {
    const newCard = {
      image: "images/img_image_1.png", // Default or dynamic image
      address,
      beds,
      price,
      area,
            ...
            <div className="flex flex-col gap-6 items-center justify-center max-w-[1200px] mx-auto w-full">
              ...
              <div className="flex flex-col gap-3 items-start justify-start w-full">
                <div className="flex md:flex-col flex-row gap-5 items-start justify-start w-full">
                  ...
                  <select   className="bg-white-A700 border border-bluegray-100 border-solid font-bold pb-3.5 pt-[18px] px-4 rounded-[10px] text-gray-700 text-left text-lg w-full" value={beds} onChange={handleBedsChange}>
                      {dropdownlargeOptionsList1.map((option) => (
                  ...
                  <div className="flex sm:flex-1 flex-col items-start justify-start w-auto sm:w-full">
                    <select   className="bg-white-A700 border border-bluegray-100 border-solid font-bold pb-3.5 pt-[18px] px-4 rounded-[10px] text-gray-700 text-left text-lg w-full" value={baths} onChange={handleBathsChange}>
                      {dropdownlargeOptionsList2.map((option) => (
                        <option key={option.value} value={option.value}>
                          {option.label}
                        </option>
                      ))}
